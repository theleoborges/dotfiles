...
;;;;; git-gutter-fr
     ...
     `(git-gutter:deleted   ((,class (:foreground ,war :weight bold))))
     `(git-gutter:modified  ((,class (:foreground ,keyword :weight bold))))
     `(git-gutter:unchanged ((,class (:background ,bg2 :foreground ,bg2 :weight bold))))
